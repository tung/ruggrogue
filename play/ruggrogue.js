...
(function() {
 var loadPackage = function(metadata) {
  ...
  var PACKAGE_NAME = "/home/tung/Projects/rust/ruggrogue/target/wasm32-unknown-emscripten/release/deps/ruggrogue.data";
  var REMOTE_PACKAGE_BASE = "ruggrogue.data";
  ...
  function runWithFS() {
   ...
   Module["FS_createPath"]("/assets", "urizen", true, true);
   ...
   function processPackageData(arrayBuffer) {
    ...
    Module["removeRunDependency"]("datafile_/home/tung/Projects/rust/ruggrogue/target/wasm32-unknown-emscripten/release/deps/ruggrogue.data");
   }
   Module["addRunDependency"]("datafile_/home/tung/Projects/rust/ruggrogue/target/wasm32-unknown-emscripten/release/deps/ruggrogue.data");
 ...
 loadPackage({
  "files": [ {
   "filename": "/assets/gohufont-8x14.png",
   "start": 0,
   "end": 1568,
   "audio": 0
  }, {
   "filename": "/assets/terminal-8x8.png",
   "start": 1568,
   "end": 2903,
   "audio": 0
  }, {
   "filename": "/assets/urizen/LICENSE",
   "start": 2903,
   "end": 9951,
   "audio": 0
  }, {
   "filename": "/assets/urizen/readme.txt",
   "start": 9951,
   "end": 10099,
   "audio": 0
  }, {
   "filename": "/assets/urizen/urizen-onebit-tileset-mono.png",
   "start": 10099,
   "end": 41221,
   "audio": 0
  } ],
  "remote_package_size": 41221,
  "package_uuid": "0e0567bf-1226-4718-91cb-a1ea807295c2"
 });
})();
...
var STACK_BASE = 5428928, STACK_MAX = 186048, DYNAMIC_BASE = 5428928, DYNAMICTOP_PTR = 185872;
...
var wasmBinaryFile = "ruggrogue.wasm";
...
function _ruggrogue_sync_idbfs() {
...
var asmLibraryArg = {
 ...
 "__gxx_personality_v0": ___gxx_personality_v0,
 ...
 "roundf": _roundf,
 "ruggrogue_sync_idbfs": _ruggrogue_sync_idbfs,
...
var dynCall_viiffj = Module["dynCall_viiffj"] = createExportWrapper("dynCall_viiffj");
...
function invoke_viiffj(index, a1, a2, a3, a4, a5, a6) {
 var sp = stackSave();
 try {
  dynCall_viiffj(index, a1, a2, a3, a4, a5, a6);
 } catch (e) {
  stackRestore(sp);
  if (e !== e + 0 && e !== "longjmp") throw e;
  _setThrew(1, 0);
...
if (!Object.getOwnPropertyDescriptor(Module, "IDBFS")) Module["IDBFS"] = function() {
 abort("'IDBFS' was not exported. add it to EXTRA_EXPORTED_RUNTIME_METHODS (see the FAQ)");
};
